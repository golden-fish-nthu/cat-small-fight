...
bool Point::overlap(const Shape& s) const {
    switch (s.getType()) {
        case ShapeType::POINT:
            return checkOverlap(this, static_cast<const Point*>(&s));
        case ShapeType::RECTANGLE:
            return checkOverlap(this, static_cast<const Rectangle*>(&s));
        case ShapeType::CIRCLE:
            return checkOverlap(this, static_cast<const Circle*>(&s));
    }
...
bool Rectangle::overlap(const Shape& s) const {
    switch (s.getType()) {
        case ShapeType::POINT:
            return checkOverlap(static_cast<const Point*>(&s), this);
        case ShapeType::RECTANGLE:
            return checkOverlap(this, static_cast<const Rectangle*>(&s));
        case ShapeType::CIRCLE:
            return checkOverlap(this, static_cast<const Circle*>(&s));
...
bool Circle::overlap(const Shape& s) const {
    switch (s.getType()) {
        case ShapeType::POINT:
            return checkOverlap(static_cast<const Point*>(&s), this);
        case ShapeType::RECTANGLE:
            return checkOverlap(static_cast<const Rectangle*>(&s), this);
        case ShapeType::CIRCLE:
            return checkOverlap(this, static_cast<const Circle*>(&s));
    }
    GAME_ASSERT(false, "Unknown ShapeType.");
